 ...
 * 
 * We want to test the doSomething() method of the ComplexSystem class,
 ...
 * 
 * This demonstrates the default behavior without using PowerMock.
 */

public class complexSystemDefaultBehaviorTest {

	@Test
	public void testDoSomething() {
		// Create the instance of our system to test
		final ComplexSystem systemUnderTest = new ComplexSystem();
		...
		// be LOTS of console output, signifying unwanted access to external
		// resources
		System.out.println("Resulting value: "
				+ systemUnderTest.doSomething(collaborator3));
	}
}
